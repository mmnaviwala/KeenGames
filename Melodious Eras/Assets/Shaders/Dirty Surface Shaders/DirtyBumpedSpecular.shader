...
float4 Multiply5=_DiffuseIntensity.xxxx * _DiffuseColor;
float4 Multiply0=Lerp0 * Multiply5;
...
float4 Multiply4=Tex2D6 * _MakeDirty.xxxx;
float4 Lerp1=lerp(Multiply2,Tex2D5,Multiply4);
