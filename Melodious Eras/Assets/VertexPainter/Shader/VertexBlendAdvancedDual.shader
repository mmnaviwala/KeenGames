Shader "Vertex Paint/Vertex Blend Advanced Dual/Normal"
{
	properties {
	...
	subshader {
		...
		void surf (Input IN, inout SurfaceOutput o) {
			...
			//Noise
			fixed term = pow( (splat_control.r + ( (1-splat_control.r) *  (splat2Normal.r*splat_control.g)) + ( (splat2Normal.r*splat_control.g) * splat_control.r) * 1 ), splat_control.a*25 );
